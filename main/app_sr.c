        ...
        if (detect_flag == 1) {
            ...
            if (mn_state == ESP_MN_STATE_DETECTED) { // 已检测到命令词
                ...
                switch (mn_result->command_id[0])
                {
                    ...
                    case 2: // shan shuo 闪烁
                        app_led_strip_task_clear();
                        app_led_strip_blink_task_start(50, 0, 0);
                        break;
                    case 3: // hu xi 呼吸
                        app_led_strip_task_clear();
                        app_led_strip_breath_task_start(50, 0, 0);
                        break;
                    case 4: // chang liang 常亮
                        app_led_strip_task_clear();
                        app_led_strip_set_one_color(50, 0, 0);
                        break;


                    case 5: // shan shuo 闪烁
                        app_led_strip_task_clear();
                        app_led_strip_blink_task_start(0, 50, 0);
                        break;
                    case 6: // hu xi 呼吸
                        app_led_strip_task_clear();
                        app_led_strip_breath_task_start(0, 50, 0);
                        break;
                    case 7: // chang liang 常亮
                        app_led_strip_task_clear();
                        app_led_strip_set_one_color(0, 50, 0);
                        break;
                    

                    case 8: // shan shuo 闪烁
                        app_led_strip_task_clear();
                        app_led_strip_blink_task_start(0, 0, 50);
                        break;
                    case 9: // hu xi 呼吸
                        app_led_strip_task_clear();
                        app_led_strip_breath_task_start(0, 0, 50);
                        break;
                    case 10: // chang liang 常亮
                        app_led_strip_task_clear();
                        app_led_strip_set_one_color(0, 0, 50);
                        break;

                    case 11: // color jian bian 彩色渐变
                        app_led_strip_task_clear();
                        app_led_strip_color_breath_task_start();
                        break;

                    case 12: // color liu guang 彩色流光
                        app_led_strip_task_clear();
